...
(* Main FastFourierTransform function. 20 points. The submission must compile without errors. 
...
implement $DC.DC_base_test<> (pair) = ceq(pair.1, cmake(1.0,0.0))

(* Please implement this function *)
implement $DC.DC_base_solve<> (pair) = pair.0

(* Please implement this function *)
implement $DC.DC_divide<> (pair) = 
	let
	//how to get odd and even complex numbers
	in

	end

(* Please implement this function *)
implement $DC.DC_conquer_combine<> (input, outputs) = 
...
implement main0 () = benchmark (4096, 100)
